...
?>
    ...
    <div class="productos-categoria">
        <h2>Productos en categoría: <?php echo $nombre_categoria; ?></h2>
        ...
        <?php } ?>
        <p>
            <a href="./?vista=productos">← Volver a categorías</a>
        </p>
    </div>
<?php
} else {
...
?>
    <div class="categorias-productos">
        <h2>Catálogo de categorías de productos</h2>
        <div class="lista-categorias">
            <?php while ($row = $rs->fetch_assoc()): ?>
                <article class="categoria">
                    <a href="./?vista=productos&cat=<?php echo $row['id_categoria']; ?>" style="text-decoration: none; color: inherit;">
                        <h3>
