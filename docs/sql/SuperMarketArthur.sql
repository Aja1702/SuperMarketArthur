...
VALUES (
    ...
    (
        'MODO_MANTENIMIENTO',
        '0',
        'Modo mantenimiento (0=desactivado, 1=activado)'
    ),
    (
        'IP_CONFIANZA',
        '::1',
        'IP que puede acceder en modo mantenimiento'
    ),
    (
        'VALORACIONES_HABILITADAS',
        '1',
        'Habilitar sistema de valoraciones (0=no, 1=si)'
    );