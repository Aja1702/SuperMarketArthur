    ...
    <form id="registroForm" method="post" action="/SuperMarketArthur/registro">
        ...
        <div class="form-group-registro">
            <div class="input-group-registro">
                ...
                <img class="img-error-form" src="./public/assets/img/errores/obligatorio.png" alt="Obligatorio" id="error_nombre">
            </div>

            <div class="input-group-registro">
                <label for="apellido1">Primer apellido</label>
                <input type="text" id="apellido1" name="apellido1" title="Solo letras y espacios">
                <img class="img-error-form" src="./public/assets/img/errores/obligatorio.png" alt="Obligatorio" id="error_apellido1">
            </div>
        ...
        <div class="form-group-registro">
            <div class="input-group-registro">
                ...
                <img class="img-error-form" src="./public/assets/img/errores/obligatorio.png" alt="Obligatorio" id="error_password">
                <span id="error_password_s" style="color: red; display: none;"></span>
            </div>
            <div class="input-group-registro">
                <label for="confirm_password">Confirmar contraseña</label>
                <input type="password" id="confirm_password" name="confirm_password">
                <img class="img-error-form" src="./public/assets/img/errores/obligatorio.png" alt="Obligatorio" id="error_confirm_password">
        ...
        <div class="form-group-registro">
            <div class="input-group-registro">
                ...
                <img class="img-error-form" src="./public/assets/img/errores/obligatorio.png" alt="Obligatorio" id="error_calle">
            </div>
            <div class="input-group-registro">
                <label for="numero">Número (letra)</label>
                <input type="text" id="numero" name="numero">
                <img class="img-error-form" src="./public/assets/img/errores/obligatorio.png" alt="Obligatorio" id="error_numero">
            </div>
            <div class="input-group-registro">
                <label for="portal_piso">Portal</label>
                <input type="text" id="portal_piso" name="portal_piso">
                <img class="img-error-form" src="./public/assets/img/errores/obligatorio.png" alt="Obligatorio" id="error_portal_piso">
            </div>
        </div>
        ...
        <div class="form-group-registro">
            <div class="input-group-registro">
                ...
                <img class="img-error-form" src="./public/assets/img/errores/obligatorio.png" alt="Obligatorio" id="error_tlfn">
            ...
            <div class="input-group-registro">
                ...
                <img class="img-error-form" src="./public/assets/img/errores/obligatorio.png" alt="Obligatorio" id="error_email">
        ...
        <div class="form-group-registro">
            <div class="radio-group-registro">
                ...
                <img class="img-error-form" src="./public/assets/img/errores/obligatorio.png" alt="Obligatorio" id="error_tipo_doc">
            </div>
            <div class="input-group-registro">
                <label for="caja_dni_nie">Documento</label>
                <input type="text" id="caja_dni_nie" name="caja_dni_nie">
                <img class="img-error-form" src="./public/assets/img/errores/obligatorio.png" alt="Obligatorio" id="error_caja_dni_nie">
        ...
        <div class="form-group-registro">
            <div class="input-group-registro">
                ...
                <img class="img-error-form" src="./public/assets/img/errores/obligatorio.png" alt="Obligatorio" id="error_fecha_nacer">
