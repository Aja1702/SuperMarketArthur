    ...
    <ul>
        ...
        <li>
            <a href="<?php echo BASE_URL; ?>favoritos" class="menu-link">
                <i class="far fa-heart" style="font-size: 20px; display: block; line-height: 1;"></i>
                <span>Favoritos</span>
            </a>
        </li>
        <li>
         ...
         <li>
            <a href="<?php echo BASE_URL; ?>sobre-nosotros" class="menu-link">
                <img src="<?php echo BASE_URL; ?>public/assets/img/menu_nav/sobre_nosotros.png" alt="" aria-hidden="true" />
