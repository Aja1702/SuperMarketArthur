<footer class="footer-contenido" role="contentinfo" aria-label="Pie de página SuperMarketArthur">
    <div class="footer-grid">
        <div class="footer-info">
            ...
            <p>Llevamos la frescura del campo directamente a tu mesa con la mejor selección de productos locales e internacionales.</p>
    ...
    <div class="copyright-v2">
        <p>&copy; <?php echo date("Y"); ?> SuperMarketArthur&trade; — Calidad garantizada desde 2024.</p>
    </div>
</footer>